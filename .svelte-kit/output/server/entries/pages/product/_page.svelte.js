...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`</div> <div class="w-full lg:w-48"><label for="sort-select" class="block text-sm font-semibold text-gray-700 mb-2">Sort By</label> `);
    $$renderer2.select(
      {
        id: "sort-select",
        value: sortBy,
